...
var optionSelectValue;
(function (optionSelectValue) {
    optionSelectValue[optionSelectValue["Value1"] = 0] = "Value1";
    optionSelectValue[optionSelectValue["Value2"] = 1] = "Value2";
    optionSelectValue[optionSelectValue["Value3"] = 2] = "Value3";
})(optionSelectValue || (optionSelectValue = {}));
var select1 = optionSelectValue.Value2;
$().ready(function () {
    //
    // Home ページを表示するための処理
    //
